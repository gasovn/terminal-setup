-- Scan directory list loader.
-- Tries to load real base directories from <repo>/private/wezterm/scan-dirs.lua.
-- Falls back to empty list if private config is not present.
-- See scan-dirs.example.lua for the expected format.
...
local ok, dirs = pcall(dofile, wezterm_dir .. '/../../private/wezterm/scan-dirs.lua')
